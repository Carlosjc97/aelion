...
class WelcomeLessonScreen extends StatefulWidget {
  ...
  @override
  State<WelcomeLessonScreen> createState() => _WelcomeLessonScreenState();
}

class _WelcomeLessonScreenState extends State<WelcomeLessonScreen> {
  @override
  void initState() {
    super.initState();
