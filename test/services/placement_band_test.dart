...
void main() {
  group('CourseApiService.placementBandForScore', () {
    test('returns beginner for scores between 0 and 49', () {
      expect(CourseApiService.placementBandForScore(-5), PlacementBand.basic);
      expect(CourseApiService.placementBandForScore(0), PlacementBand.basic);
      expect(CourseApiService.placementBandForScore(49), PlacementBand.basic);
    });
  ...
  group('CourseApiService band depth mapping', () {
    test('maps bands to default depths', () {
      expect(CourseApiService.depthForBand(PlacementBand.basic), 'intro');
    ...
    test('maps depths back to bands', () {
      expect(CourseApiService.bandForDepth('intro'), PlacementBand.basic);
